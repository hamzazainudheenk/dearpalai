...
export declare const MessageTemplates: {
    ...
    readonly TEXT_RECEIVED: "Hello! 👋 I'm DearPal.\n\nHow are you feeling today?";
    /** Reply sent after receiving a voice message */
    readonly VOICE_RECEIVED: "Voice message received successfully.";
    /** Reply sent when an unsupported message type is received */
    readonly UNSUPPORTED_TYPE: "This message type is not supported yet.";
    /** Reply sent when an error occurs during processing */
    readonly PROCESSING_ERROR: "Sorry, something went wrong while processing your message. Please try again.";
    /** Reply sent when rate limit is exceeded */
    readonly RATE_LIMITED: "You are sending messages too quickly. Please wait a moment and try again.";
    /** Reply sent when the service is temporarily unavailable */
    readonly SERVICE_UNAVAILABLE: "Our service is temporarily unavailable. Please try again later.";
};
